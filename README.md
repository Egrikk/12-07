...
### Таблица 4: Вертикальный шардинг
...
### Таблица 5: Горизонтальный шардинг
...
### Таблица 6: Шардинг для репликации
...
### В итоге мы получаем 3 сервиса разделенных между собой по предметным областям (Таблица 4), так как в данной концепции большую часть данных занимают книги их разбивают по ключевому критетерию на дополнительные шарды (Таблица 5) для примера взят **жанр** так как основым запрос зачастую является жанр, писатель или название, каждый из них имеет свои плюсы и минусы. Финальным становится шард для репликции и резервного хранилища (Таблица 6)
